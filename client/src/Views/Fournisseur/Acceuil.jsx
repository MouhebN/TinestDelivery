...
function Homepage() {
    ...
    return (
        ...
        <div className="homepage-container" style={{ marginTop: 50, padding: 1, position: 'relative', width:1150,marginRight:50,left :140}}>
            ...
            <div className="button-section">
                ...
                <div className="status-button-group" >
                    {['en attente', 'en stock', 'en cours', 'retour en stock', 'retour définitif', 'livré', 'livré et payé', 'en pickup',
                        'annulé','payé fournisseur', 'echange crée', 'echange livré'].map((status) => (
                        <Button
                            key={status}
                            size="large"
                            type="primary"
