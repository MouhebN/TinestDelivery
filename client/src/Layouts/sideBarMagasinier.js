    ...
    return (
        <Box sx={{display: 'flex'}}>
            ...
            >
                ...
                <Divider/>
                <List>
                    {['Ajouter Colis', 'Attribuer Colis', 'Retour', 'Stock'].map((text, index) => (
                        <ListItem key={text} disablePadding sx={{display: 'block'}}>
                            <ListItemButton component={Link} to={
                                text === 'Attribuer Colis'
                                    ? '/attribuerColis'
                                    : text === 'Ajouter Colis'
                                        ? '/ajouterColisAuStock'
                                        : text === 'Retour'
                            ...
                            >
                                ...
                                >
                                    {index % 4 === 0 ? <IoAddSharp/> : index % 3 === 0 ?
                                        <FcDataSheet/> : index % 2 === 0 ? <TbTruckReturn/> : <CiDeliveryTruck/>}
